...
export default function PracticePage() {
  ...
  if (cards.length === 0) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center max-w-lg mx-auto pb-16 px-4 gap-4">
  ...
  if (done) {
    ...
    return (
      <main className="min-h-screen flex flex-col items-center justify-center max-w-lg mx-auto pb-16 px-4 gap-6">
