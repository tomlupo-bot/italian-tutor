...
export default function Home() {
  ...
  if (isFirstRun) {
    return (
      <main className="max-w-lg mx-auto pb-24 px-4 py-12 flex flex-col items-center gap-6 text-center">
  ...
  return (
    <main className="max-w-lg mx-auto pb-24 px-4 py-4 flex flex-col gap-5">
      {/* Stats bar */}
      {stats && (
