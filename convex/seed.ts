...
const baseVocab = [
  ...
  { it: "a destra", en: "to the right", example: "La farmacia è a destra.", tag: "travel", level: "A1" },
  { it: "a sinistra", en: "to the left", example: "La stazione è a sinistra.", tag: "travel", level: "A1" },
  { it: "dritto", en: "straight ahead", example: "Vai sempre dritto.", tag: "travel", level: "A1" },
  { it: "vicino", en: "near", example: "L'hotel è vicino alla stazione.", tag: "travel", level: "A1" },
  { it: "lontano", en: "far", example: "Il supermercato è lontano.", tag: "travel", level: "A1" },
  { it: "la stazione", en: "the station", example: "La stazione è qui vicino.", tag: "travel", level: "A1" },
  ...
  // ─── Tech & Digital
  { it: "l'intelligenza artificiale", en: "artificial intelligence", example: "L'intelligenza artificiale sta cambiando tutto.", tag: "work", level: "B1" },
  { it: "il codice sorgente", en: "source code", example: "Ho scritto il codice sorgente in Python.", tag: "work", level: "B1" },
  { it: "l'aggiornamento", en: "the update", example: "C'è un nuovo aggiornamento disponibile.", tag: "work", level: "B1" },
  { it: "scaricare", en: "to download", example: "Devo scaricare l'applicazione.", tag: "work", level: "B1" },
  // ─── Emotions & Relationships (extended)
  { it: "innamorarsi", en: "to fall in love", example: "Mi sono innamorato al primo sguardo.", tag: "social", level: "B1" },
  { it: "litigare", en: "to argue / to quarrel", example: "Non mi piace litigare per niente.", tag: "social", level: "B1" },
  { it: "fare pace", en: "to make up / to reconcile", example: "Dopo la discussione abbiamo fatto pace.", tag: "social", level: "B1" },
  { it: "essere geloso", en: "to be jealous", example: "Non essere geloso, è solo un amico.", tag: "social", level: "B1" },
  { it: "fidarsi di", en: "to trust (someone)", example: "Mi fido di te completamente.", tag: "social", level: "B1" },
  { it: "tradire", en: "to betray / to cheat on", example: "Non potrei mai tradire la fiducia di qualcuno.", tag: "social", level: "B1" },
  { it: "il/la partner", en: "the partner", example: "Il mio partner è molto comprensivo.", tag: "social", level: "B1" },
  { it: "la coppia", en: "the couple", example: "Sono una coppia molto affiatata.", tag: "social", level: "B1" },
  { it: "andare d'accordo", en: "to get along", example: "Andiamo d'accordo su tutto.", tag: "social", level: "B1" },
  { it: "il rapporto", en: "the relationship", example: "Il nostro rapporto è migliorato molto.", tag: "social", level: "B1" },
  { it: "sentirsi solo/a", en: "to feel lonely", example: "A volte mi sento solo la sera.", tag: "social", level: "B1" },
  { it: "preoccuparsi", en: "to worry", example: "Non preoccuparti, andrà tutto bene.", tag: "social", level: "B1" },
  { it: "vergognarsi", en: "to be ashamed / embarrassed", example: "Mi vergogno di quello che ho detto.", tag: "social", level: "B1" },
  { it: "arrabbiarsi", en: "to get angry", example: "Mi arrabbio quando le cose non funzionano.", tag: "social", level: "B1" },
  { it: "commuoversi", en: "to be moved (emotionally)", example: "Mi sono commosso guardando quel film.", tag: "social", level: "B1" },
  // ─── Shopping & Errands
  ...
  // ─── Weather & Nature
  { it: "il temporale", en: "the thunderstorm", example: "Sta arrivando un temporale.", tag: "travel", level: "B1" },
  { it: "la grandine", en: "the hail", example: "La grandine ha danneggiato le macchine.", tag: "travel", level: "B1" },
  { it: "nevicare", en: "to snow", example: "Ha nevicato tutta la notte.", tag: "travel", level: "B1" },
  { it: "il vento forte", en: "strong wind", example: "Oggi c'è un vento forte incredibile.", tag: "travel", level: "B1" },
  { it: "l'afa", en: "the muggy heat / humidity", example: "Non sopporto l'afa estiva.", tag: "travel", level: "B1" },
  { it: "umido", en: "humid / damp", example: "Il clima qui è molto umido.", tag: "travel", level: "B1" },
  { it: "sereno", en: "clear (sky)", example: "Domani sarà sereno tutto il giorno.", tag: "travel", level: "B1" },
  { it: "nuvoloso", en: "cloudy", example: "Il cielo è nuvoloso ma non piove.", tag: "travel", level: "B1" },
  { it: "la previsione del tempo", en: "the weather forecast", example: "Hai visto la previsione del tempo?", tag: "travel", level: "B1" },
  { it: "il tramonto", en: "the sunset", example: "Il tramonto sul mare è bellissimo.", tag: "travel", level: "B1" },
  // ─── Social Life
  ...
  // ─── Media & Entertainment
  { it: "il telegiornale", en: "the TV news", example: "Guardo il telegiornale ogni sera.", tag: "social", level: "B1" },
  { it: "il documentario", en: "the documentary", example: "Ho visto un documentario interessantissimo.", tag: "social", level: "B1" },
  { it: "la serie tv", en: "the TV series", example: "Sto guardando una nuova serie tv.", tag: "social", level: "B1" },
  { it: "il personaggio", en: "the character", example: "Il personaggio principale è molto complesso.", tag: "social", level: "B1" },
  { it: "la trama", en: "the plot", example: "La trama del film è avvincente.", tag: "social", level: "B1" },
  { it: "il regista", en: "the director (film)", example: "Chi è il regista di questo film?", tag: "social", level: "B1" },
  { it: "lo spettacolo", en: "the show / performance", example: "Lo spettacolo è stato emozionante.", tag: "social", level: "B1" },
  { it: "il palcoscenico", en: "the stage", example: "Gli attori sono saliti sul palcoscenico.", tag: "social", level: "B1" },
  { it: "recitare", en: "to act / to perform", example: "Ha recitato in molti film famosi.", tag: "social", level: "B1" },
  { it: "il concerto", en: "the concert", example: "Andiamo al concerto stasera?", tag: "social", level: "B1" },
];
